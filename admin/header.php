...
<html lang="en">
   <head>
      ...
      <title>Vaagdevi Admin - Dashboard</title>
      <!-------------font awesome-------------> 
   ...
   <body id="page-top">
      ...
      <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <li class="nav-item">
            <a class="nav-link" href="naac_upload.php"> <span>NAAC UPLOADS</span></a>
         </li>
         <!-- Divider -->
         <hr class="sidebar-divider">
        ...
        <!-- <li class="nav-item">
         ...
         <li class="nav-item">
            <a class="nav-link collapsed" href="../index.php"> <span>Vaagdevi-Index</span> </a>
         </li>
