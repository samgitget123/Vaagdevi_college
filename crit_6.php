...
$select12="SELECT * FROM upload WHERE category=6 AND sub_category=38 ";
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
            <h3 class="text-center my-5">Criterion 6 - Governance, Leadership and Management</h3>
            <div class="accordion my-5" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <h6>6.1 Institutional Vision and Leadership</h6>
                    </button>
                    </h2>
                ...
                <div class="accordion-item">
                    ...
                    <h6>6.2 Strategy Development and Deployment</h6>
                    </button>
                    </h2>
                    ...
                    <!--------------second loop------------> 
                   <?php
                   $select6 = "SELECT * FROM upload WHERE category=6 AND sub_category = 39";
                ...
                <div class="accordion-item">
                    ...
                    <h6>6.3 Faculty Empowerment Strategies</h6>
                    </button>
                    </h2>
                    ...
                    <!----------------third loop----------------> 
                    <?php
                   $select7 = "SELECT * FROM upload WHERE category=6 AND sub_category = 40";
                ...
                <div class="accordion-item">
                    ...
                    <h6>6.4 Financial Management and Resource Mobilization</h6>
                    </button>
                    </h2>
                    ...
                    <!--------------fouth loop---------------->
                    <?php
                   $select8 = "SELECT * FROM upload WHERE category=6 AND sub_category = 41";
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    <h6>6.5 Internal Quality Assurance System</h6>
                    </button>
                    </h2>
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    <!--------------fouth loop---------------->
                    <?php
                   $select8 = "SELECT * FROM upload WHERE category=6 AND sub_category = 42";
                   $query8 = mysqli_query($conn , $select8);
                   $nums8=mysqli_num_rows($query8);
                   if($nums8){
                    while($file8=mysqli_fetch_assoc($query8)){
