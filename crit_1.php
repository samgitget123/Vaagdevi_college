...
$select="SELECT * FROM upload WHERE category=1 AND sub_category=7 ";
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
            <h2 class="text-center my-5">Criterion 1 – Curricular Aspects</h2>
            ...
            <div class="accordion my-5" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <h6>1.1 Curricular Planning and Implementation</h6>
                    </button>
                    </h2>
                ...
                <div class="accordion-item">
                    ...
                    <h6>1.2 Academic Flexibility</h6>
                    </button>
                    </h2>
                    ...
                    <!--------------second loop------------> 
                   <?php
                   $select2 = "SELECT * FROM upload WHERE category=1 AND sub_category = 8";
                ...
                <div class="accordion-item">
                    ...
                    <h6>1.3 Curriculum Enrichment</h6>
                    </button>
                    </h2>
                    ...
                    <!----------------third loop----------------> 
                    <?php
                   $select3 = "SELECT * FROM upload WHERE category=1 AND sub_category = 9";
                ...
                <div class="accordion-item">
                    ...
                    <!--------------fouth loop---------------->
                    <?php
                   $select4 = "SELECT * FROM upload WHERE category=1 AND sub_category = 10";
                   $query4 = mysqli_query($conn , $select4);
                   $nums=mysqli_num_rows($query4);
                   if($nums){
                    while($file4=mysqli_fetch_assoc($query4)){

                    
                   ?>
                   <!------------pdf-----------> 
                   <a href="admin/uploads/<?= $file4['pdf']; ?>" target="_blank" class="pdf"><?= $file4['pdf_title']; ?></a>
                   <!-----------pdf------------> 
                   <?php
                   }
                }
